...
1. Schaut euch den Datensatz nochmals genau an. Sind alle Regeln erfüllt um diesen Datensatz als Tidy data beschreiben zu können?

- Regel 1: Jede Spalte ist eine Variable
- Regel 2: Jede Reihe ist eine Beobachtung
- Regel 3: Jede Zelle enthält eine Messung
