...
5. Klicke nun im File Manager auf den Ordner um den Inhalt zu sehen 
...
1. Schaut euch den Datensatz nochmals genau an. Sind alle Eigenschaften vorhanden um diesen Datensatz als Tidy data beschreiben zu können?
